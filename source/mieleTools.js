...
async function createStatePlateStep(adapter, path, value){
    for (const n in value) {
        ...
        await createROState(adapter, MyPath , 'The plateStep object represents the selected cooking zone levels for a hob (localized value).', value[n].value_localized, 'string', 'text');
